...
//   { id: 2, text: 'تسجيل وتوثيق حساب مقدم التدريب', icon: UserPlus, path: '/training/addaccount' },
  { id: 3, text: '  البرامج التدريبيه ', icon: Calendar, path: '/training/schedule' },
  { id: 4, text: 'إدارة الجدول الزمني', icon: Settings, path: '/training/manageschedule' },
  { id: 5, text: 'جلسات اليوم ', icon: BookOpen, path: '/training/execute' },
  { id: 6, text: 'بيانات المتدربين ', icon: ClipboardList, path: '/training/attendance' },
